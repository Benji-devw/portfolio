                        ...
                        <div className="col-12 p-2 col-lg-8 footer__left">
                            <ul className="footer__links h-100 align-items-center justify-content-center">
                                <li className="footer__item">
                                    <Link to="web__wrapper" spy={true} smooth={true} offset={-100} duration={500}>
                                        Web
                                    </Link>
                                </li>
                                <li className="footer__item">
                                    <Link to="design__wrapper" spy={true} offset={-100} duration={500}>
                                        DESIGN
                                    </Link>
                                </li>
                                <li className="footer__item">
                                    <Link to="three__wrapper" spy={true} offset={-100} duration={500}>
                                        3D
                                    </Link>
                                </li>
                            </ul>
                        ...
                        <div className="col-12 p-2 col-lg-4 grid gap-3 footer__right">
                            ...
                            <div className="footer__Link">
                                <a href="https://github.com/Benji-devw" target="_blank" rel="noreferrer">
                                    <Image src={`${router.basePath}/media/Github_Icon.svg`} alt={'git_img'} priority height={38} width={38} />
                                </a>
                            </div>
                            <div className="footer__Link">
                                <a href="https://www.linkedin.com/in/benjamin-navarro-586713220/" target="_blank" rel="noreferrer">
                                    <Image src={`${router.basePath}/media/in_Icon.svg`} alt={'git_img'} priority height={38} width={38} />
                                </a>
                            </div>
                        </div>
