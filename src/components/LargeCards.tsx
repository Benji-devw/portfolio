    ...
    <div className="col-12 col-lg-10 mx-auto large__card_cv__preview">
      <div className="row g-0 h-100">
        <div className="col-md-8 p-2 large__card__text">
            ...
            <code className='large__card__cv mx-auto'><a href="/media/Navarro_Benjamin_CV_2023.pdf" target="_blank" rel="noopener noreferrer" >Télécharger le CV</a></code>
        </div>
        <div className="col-md-4 p-2 cv__preview__image  mx-auto">
          <div className="large__card__body">
          <Image src={"/media/cv_preview.jpg"} alt="icon" width={800} height={800} />
          </div>
        </div>
      </div>
    </div>
